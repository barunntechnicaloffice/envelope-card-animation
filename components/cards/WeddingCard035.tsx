...
interface WeddingCard035Data extends WeddingData {
  decoration?: string
}

interface WeddingCard035Props {
  data: WeddingCard035Data
  layout?: any
  className?: string
  style?: React.CSSProperties
}

export function WeddingCard035({
  data,
  layout,
  className,
  style
