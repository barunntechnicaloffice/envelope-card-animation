...
interface WeddingCard038Data extends WeddingData {
  decoration?: string
}

interface WeddingCard038Props {
  data: WeddingCard038Data
  layout?: any
  className?: string
  style?: React.CSSProperties
}

export function WeddingCard038({
  data,
  layout,
  className,
  style
    ...
    >
      ...
      {data.photo && layout.photo && (
        <div style={{
          ...
          overflow: 'hidden',
          borderRadius: layout.photo.borderRadius || '1000px 1000px 0 0'
        }}>
          <img
            src={data.photo}
            alt="Wedding Photo"
